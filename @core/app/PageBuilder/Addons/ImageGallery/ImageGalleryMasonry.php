...
class ImageGalleryMasonry extends PageBuilderBase
{
    ...
    public function admin_render()
    {
        ...
        foreach ($all_languages as $key => $lang) {
            ...
            $categories = ImageGalleryCategory::where(['lang' => $lang->slug,'status' => 'publish'])->get()->pluck('name','id')->toArray();
    ...
    public function frontend_render()
    {
        ...
        if (!empty($categories)){
            $all_work_category = WorksCategory::whereIn('id',$all_contain_cat)->get();
        }else{
...
HTML;
    ...
    {
        return __('Image Gallery Masonry: 02');
    }
}