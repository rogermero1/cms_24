    ...
    public function frontend_render()
    {
        ...
        foreach ($all_products as $item){
            ...
            if($item->stock_status == 'out_stock'){
                ...
                $cart_icon_markup = '<a href="'.route('frontend.products.add.to.cart').'" class="addtocart ajax_add_to_cart" data-product_id="'.$item->id.'" data-product_title="'.$item->title.'" data-product_quantity="1"><i class="fa fa-shopping-bag" aria-hidden="true"></i> '.$button_text.'</a>';
            }
