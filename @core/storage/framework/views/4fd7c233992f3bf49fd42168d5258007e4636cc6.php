                            ...
                            <td scope="row">
                                <div class="user-dahsboard-order-info-wrap">
                                    ...
                                    <?php if(!empty($data->event) && $data->payment_status == 'complete'): ?>
                                        ...
                                        <form action="<?php echo e(route('user.dashboard.event.ticket.generate')); ?>"  method="post">
                                            <?php echo csrf_field(); ?>
                                            <input type="hidden" name="id" value="<?php echo e($data->id); ?>">
                                            <button class="btn btn-primary margin-top-20" type="submit"><?php echo e(__('Ticket')); ?></button>
                                        </form>
                                    <?php endif; ?>
                                </div>
                            </td>
...
<?php echo $__env->make('frontend.user.dashboard.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/nexelit/@core/resources/views/frontend/user/dashboard/event-booking.blade.php ENDPATH**/ ?>