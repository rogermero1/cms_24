            ...
            <div class="table-responsive cart-table">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th><?php echo e(__('Event Info')); ?></th>
                    </tr>
                    <tr>
                        <td>
                            <div class="thumbnail">
                        ...
                        <td>
                            <div class="event-info-wrap">
                                <ul>
                                    <li><strong><?php echo e(__('Attendance ID')); ?>:</strong> #<?php echo e($attendance_details->id); ?></li>
                                    <li><strong><?php echo e(__('Event Title')); ?>:</strong> <?php echo e($attendance_details->event_name); ?></li>
                                    <li><strong><?php echo e(__('Ticket Price')); ?>:</strong> <?php echo e(amount_with_currency_symbol($attendance_details->event_cost,true)); ?></li>
                                    <li><strong><?php echo e(__('Ticket Quantity')); ?>:</strong> <?php echo e($attendance_details->quantity); ?></li>
                                    <li><strong><?php echo e(__('Subtotal')); ?>:</strong> <?php echo e(amount_with_currency_symbol((int) $attendance_details->event_cost * (int)$attendance_details->quantity,true)); ?></li>
                                    <li><strong><?php echo e(__('Booking Status')); ?>:</strong> <?php echo e($attendance_details->status); ?></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
        ...
        <div class="cart-total-table table-responsive">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><?php echo e(amount_with_currency_symbol($payment_log->event_cost,true)); ?></td>
                </tr>
                <tr>
