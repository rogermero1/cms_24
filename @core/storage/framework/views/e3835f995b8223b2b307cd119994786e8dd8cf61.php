...
<head>
    ...
    <title><?php echo e(__('Events Ticket')); ?></title>
    <style>
...
<body>
    <div id="pdf_content_wrapper">
        ...
        <div class="cart-table-wrapper cart-wrapper">
            <ul>
                <li><strong><?php echo e(__('Attendance Name')); ?> </strong> <?php echo e($payment_log->name); ?></li>
                <li><strong><?php echo e(__('Event Name')); ?> </strong> <?php echo e(optional($attendance_details->event)->title); ?></li>
                <li><strong><?php echo e(__('Venue Name')); ?> </strong> <?php echo e(optional($attendance_details->event)->venue); ?></li>
                <li><strong><?php echo e(__('Venue Location')); ?> </strong> <?php echo e(optional($attendance_details->event)->venue_location); ?></li>
                <li><strong><?php echo e(__('Venue Phone')); ?> </strong> <?php echo e(optional($attendance_details->event)->venue_phone); ?></li>
            </ul>
            <div class="qr-code-wrapper">
                <?php if(file_exists($file_name)): ?>
                    <img src="<?php echo e(asset($file_name)); ?>" alt="">
                <?php endif; ?>    
            </div>
        </div>
    </div>
...
<?php /**PATH /home/xgenxchi/public_html/laravel/nexelit/@core/resources/views/ticket/event-ticket.blade.php ENDPATH**/ ?>